...
| §7 quantitative evaluation (Figure 5: entropy + similarity per turn, bootstrap CIs) | implemented; run on real AMBROSIA + GPT-4o + MiniLM (see `02-execution-results.md`) |
